...
theme_path = "/home/chris/.config/awesome/theme/theme"
...
tags[1][8].name = 'mpl'
tags[1][9].name = 'wow'
keybinding({ "Mod1", "Control" }, "l", function () awful.util.spawn('xscreensaver-command -lock') end):add()
keybinding({ modkey }, "p",
  function () awful.util.spawn('mydmenu.sh') end):add()
keybinding({ modkey }, "`",
function ()
  local screen = mouse.screen
